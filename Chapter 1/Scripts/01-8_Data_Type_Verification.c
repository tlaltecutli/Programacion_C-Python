/*
Script to verify data types in C
Author: Zeus Dominguez
Date: Monday September 8, 2025

This script declares variables of different data types, prints their values,
sizes, and ranges using standard library macros.
